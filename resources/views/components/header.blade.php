    <header class="fixed top-0 z-10 w-full bg-green-800 shadow">
            ...
            <div class="flex h-32 items-center justify-between">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <a href="/" :active="request()->is('/')" class="flex items-center font-bold text-4xl"><img class="h-8 w-8" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Logo SMK NU Kejajar">SMK NU Kejajar</a>
                    </div>
                </div>
                <div class="flex items-center">
